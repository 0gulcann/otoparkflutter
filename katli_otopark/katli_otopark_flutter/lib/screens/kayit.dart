...
import 'package:katli_otopark_flutter/widgets/input_field.dart';
...
class _kayitPageState extends State<kayitPage> {
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              style: TextStyle(fontWeight:
               FontWeight.bold,fontSize: 25),
                ...
                MyInputField(title: "Plaka", hint: "Plakayı Girin",controller: _plakaController,),
                MyInputField(title: "Marka", hint: "Markayı Girin",controller: _markaController,),
                Row(
                  children: [
                    Expanded(
                      child:
                       MyInputField(
                        title: "Giriş Saati", hint: _startTime,              
                    ),
                    ),
                     IconButton(   
                        onPressed: (){     
    ...
    Get.to(() => kayitlarPage());
      ...
      Get.snackbar("Zorunlu", "Bütün Alanların Doldurulması Zorunludur",
